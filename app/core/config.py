...
GLOBAL_API_RATE_LIMIT_ENABLED = os.getenv("GLOBAL_API_RATE_LIMIT_ENABLED", "true").lower() == "true"
GLOBAL_API_RATE_LIMIT_MAX_REQUESTS = int(os.getenv("GLOBAL_API_RATE_LIMIT_MAX_REQUESTS", "400"))
GLOBAL_API_RATE_LIMIT_WINDOW_SECONDS = int(os.getenv("GLOBAL_API_RATE_LIMIT_WINDOW_SECONDS", "60"))
REGISTER_RATE_LIMIT_MAX_REQUESTS = int(os.getenv("REGISTER_RATE_LIMIT_MAX_REQUESTS", "8"))
...
GLOBAL_API_RATE_LIMIT_MAX_REQUESTS = int(os.getenv("GLOBAL_API_RATE_LIMIT_MAX_REQUESTS", "400"))
GLOBAL_API_RATE_LIMIT_WINDOW_SECONDS = int(os.getenv("GLOBAL_API_RATE_LIMIT_WINDOW_SECONDS", "60"))
REGISTER_RATE_LIMIT_MAX_ATTEMPTS = int(os.getenv("REGISTER_RATE_LIMIT_MAX_ATTEMPTS", "5"))
REGISTER_RATE_LIMIT_WINDOW_SECONDS = int(os.getenv("REGISTER_RATE_LIMIT_WINDOW_SECONDS", "3600"))
TRUSTED_HOSTS = [
    h.strip()
    for h in os.getenv("TRUSTED_HOSTS", "").split(",")
...
REQUIRE_SMS_VERIFICATION = os.getenv("REQUIRE_SMS_VERIFICATION", "true").lower() == "true"
